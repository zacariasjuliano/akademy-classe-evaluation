...
## ⚙️ Módulo Akademy CLASSE EVALUATION

O **Akademy CLASSE EVALUATION (Gestão Administrativa)** é um módulo complementar responsável por **expandir as funcionalidades** dos módulos de **Gestão Pedagógica** e **Gestão Administrativa**, oferecendo ferramentas avançadas para administração escolar, gestão de pessoal e acompanhamento de desempenho institucional.
